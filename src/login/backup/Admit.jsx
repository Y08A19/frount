...
import canExport from "./imagein/ImageUploadPreviewComponent"
    ...
    <div className="opip" ref={componentRef}>
      <div>
        <div>
          ...
          <div className="hed">
            <img src={require("./logscr/header-admit.jpg")} width="1300px" height="250px"  />
          </div>
          ...
          <p>
            ...
            ________ in the following subjects
          </p>
          {canExport ?
